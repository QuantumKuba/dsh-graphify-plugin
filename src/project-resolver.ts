...
export class ProjectResolver {
  private cache = new Map<string, CachedProjectEntry>()
   ...
   */
  private detectForDirectory(targetDir: string): ResolvedProject {
   ...
   */
  private isCacheValid(project: ResolvedProject): boolean {
